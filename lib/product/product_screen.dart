                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Text(
                                                "${_getPrice(_searchResult[index]).isNotEmpty ? _getPrice(_searchResult[index]) : 0} ${Provider.of<ZMetaData>(context, listen: false).currency}",
                                                style: Theme.of(context)
                                                    .textTheme
                                                    .titleSmall
                                                    ?.copyWith(
...
//   // List<dynamic> _allLoadedProducts = [];
...
//   // Modify _getStoreProductList to handle pagination
//   void _getStoreProductList() async {
//     //
//     setState(() {
//       _loading = true;
...
//     debugPrint("products>>>: $responseData");
//     if (responseData != null && responseData['success']) {
//       // If paginating, append; else, replace
//       if (_currentPage == 1) {
//         products = List.from(responseData['products']);
//       } else {
//         products.addAll(responseData['products']);
//       }
//       // When first loading, initialize the _allLoadedProducts list
//       // if (_currentPage == 1) {
//       //   _allLoadedProducts = [];
//       // }
//     } else {
...
//   // Add a method to load more products
...
//   Widget build(BuildContext context) {
//     return Scaffold(
//       // Your existing app bar and other UI elements
//       appBar: AppBar(
//         title: Text(
//           Service.capitalizeFirstLetters(widget.store['name']),
//           style: Theme.of(context).textTheme.titleMedium?.copyWith(
...
//                 // );
//               } else {
//                 ScaffoldMessenger.of(context).showSnackBar(Service.showMessage11(
...
//             child: Column(
//               children: [
//                 // Your existing search and header components
...
//                           shrinkWrap: true,
//                           itemCount:
//                               _searchResult.length + (_isLoadingMore ? 1 : 0),
//                           itemBuilder: (BuildContext context, int index) {
...
//                             return InkWell(
//                                 // Your existing InkWell code for product items
//                                 );
//                           },
//                           separatorBuilder: (BuildContext context, int index) =>
//                               SizedBox(
...
//                                     itemBuilder:
//                                         (BuildContext context, int index) {
//                                       // Your existing ExpansionTile code
//                                       return ExpansionTile(
//                                         // Your existing ExpansionTile code
...
//                                                                             null &&
//                                                                         products[index]['items'][idx]['details'].length >
//                                                                             0
//                                                                     ? Text(
//                                                                         products[index]['items'][idx]
//                                                                             [
...
//                                                                           0) {
//                                                                         if (isLoggedIn) {
//                                                                           productClicked(products[index]['items'][idx]
//                                                                               [
//                                                                               '_id']);
//                                                                         }
...
//                                                                                 ),
//                                                                               ).then((value) => getCart())
//                                                                             : ScaffoldMessenger.of(context).showSnackBar(Service.showMessage11("Sorry the store is closed at this time!", true));
//                                                                       } else {
//                                                                         // TODO: Add to cart.....
...
//                                                                           noteForItem:
//                                                                               "",
//                                                                           price: _getPrice(products[index]['items'][idx]) != null
//                                                                               ? double.parse(
//                                                                                   _getPrice(products[index]['items'][idx]),
//                                                                                 )
//                                                                               : 0,
...
//                                                                           imageURL: products[index]['items'][idx]['image_url'].length > 0
//                                                                               ? "${Provider.of<ZMetaData>(context, listen: false).baseUrl}/${products[index]['items'][idx]['image_url'][0]}"
//                                                                               : "https://ibb.co/vkhzjd6",
//                                                                         );
//                                                                         StoreLocation
...
//                                                                               });
//                                                                             } else {
//                                                                               _showDialog(item, destination, storeLocation, products[index]['items'][idx]['store_id']);
//                                                                             }
//                                                                           } else {
//                                                                             debugPrint("User not logged in...");
//                                                                             ScaffoldMessenger.of(context).showSnackBar(Service.showMessage11("Please login in...",
//                                                                                 true));
//                                                                             Navigator
//                                                                                 .push(
//                                                                               context,
...
//   // You'll need to modify your getStoreProductList() method to handle pagination:
//   Future<dynamic> getStoreProductList() async {
//     // var url =
//     //     "${Provider.of<ZMetaData>(context, listen: false).baseUrl}/api/user/user_get_store_product_item_list";
//     var url =
...
//     Map data = {
//       "store_id": widget.store['_id'],
//       "page": "${_currentPage}", // Add page parameter for pagination
//       "limit": "5",
//     };
//     var body = json.encode(data);
...
// //         totalItems += (category['items'] as List).length;
// //       }
...
// //     // First, flatten the products structure into a single list
// //     for (var category in products) {
// //       for (var item in category['items']) {
// //         item['category'] = category['_id']['name']; // Add category info to item
// //         allProducts.add(item);
// //       }
// //     }

// //     // Then paginate the flattened list
...
// //       _paginatedProducts = allProducts.sublist(start, end);
// //     }
// //   }
...
// //                                   child: Row(
// //                                     children: [
// //                                       _searchResult[index]['image_url'].length >
// //                                               0
// //                                           ? ImageContainer(
// //                                               url:
// //                                                   "${Provider.of<ZMetaData>(context, listen: false).baseUrl}/${_searchResult[index]['image_url'][0]}",
...
// //                               children: [
// //                                 Expanded(
// //                                   child: _paginatedProducts.length > 0
// //                                       ? ListView.separated(
// //                                           physics: ClampingScrollPhysics(),
// //                                           shrinkWrap: true,
...
// //                                                                             5)),
// //                                                                 Text(
// //                                                                   "${_getPrice(item) != null ? _getPrice(item) : 0} ${Provider.of<ZMetaData>(context, listen: false).currency}",
// //                                                                   style: Theme.of(
// //                                                                           context)
// //                                                                       .textTheme
// //                                                                       .titleSmall
...
// //                                                                           noteForItem:
// //                                                                               "",
// //                                                                           price: _getPrice(item) != null
// //                                                                               ? double.parse(_getPrice(item))
// //                                                                               : 0,
// //                                                                           itemName:
// //                                                                               item['name'],
// //                                                                           imageURL: item['image_url'].length > 0
// //                                                                               ? "${Provider.of<ZMetaData>(context, listen: false).baseUrl}/${item['image_url'][0]}"
// //                                                                               : "https://ibb.co/vkhzjd6",
// //                                                                         );
...
// //                                                                               });
// //                                                                             } else {
// //                                                                               _showDialog(cartItem, destination, storeLocation, item['store_id']);
// //                                                                             }
// //                                                                           } else {
// //                                                                             ScaffoldMessenger.of(context).showSnackBar(Service.showMessage11("Please login in...",
// //                                                                                 true));
...
// //     // If there are many pages, show limited set with ellipsis
// //     if (_totalPages <= 5) {
...
// //       }
// //     } else {
// //       // Show limited pages with ellipsis for larger sets
// //       if (_currentPage <= 2) {
...
// //         pageWidgets.add(_buildPageNumber(_totalPages - 1));
// //       } else if (_currentPage >= _totalPages - 3) {
// //         // Show first page, ellipsis, and last 3 pages
// //         pageWidgets.add(_buildPageNumber(0));
// //         pageWidgets.add(_buildEllipsis());
...
// //         height: 30,
// //         decoration: BoxDecoration(
// //           color: isCurrentPage ? kSecondaryColor : Colors.transparent,
// //           borderRadius: BorderRadius.circular(15),
// //           border: Border.all(
// //             color: isCurrentPage ? kSecondaryColor : kGreyColor,
// //             width: 1,
// //           ),
// //         ),
// //         child: Center(
...
// //             "${pageNumber + 1}",
// //             style: TextStyle(
// //               color: isCurrentPage ? kPrimaryColor : kBlackColor,
