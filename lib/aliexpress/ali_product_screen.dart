...
import 'package:zmall/aliexpress/ali_item_screen.dart';
...
class AliProductListScreen extends StatefulWidget {
  const AliProductListScreen({
    super.key,
  });

  @override
  State<AliProductListScreen> createState() => _AliProductListScreenState();
}

class _AliProductListScreenState extends State<AliProductListScreen> {
...
///////////
        ...
        appBar: AppBar(
          ...
          bottom: PreferredSize(
              ...
              child: Padding(
                ...
                child: (products.isEmpty || (isLoading && products.isEmpty)) &&
                        categories.isEmpty
                    ? SizedBox.shrink()
                    : Column(
                        children: [
  ...
  //   final GlobalKey? key = _keys[category];
    ...
    return Container(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          // isCategorySelected = category == selectedCategory;
          return InkWell(
            onTap: () {
              setState(() {
  ...
  Future<dynamic> _getAliexpressProducts() async {
    ...
    Map data =
        selectedCategory!.isNotEmpty ? {"feed_name": "$selectedCategory"} : {};
    try {
