...
class _BodyState extends State<Body> {
  ...
  void initState() {
    ...
    _scrollController = ScrollController()
      ..addListener(() {
        ...
        setState(() {
          _showTitle = offset > (_imageHeight - _collapsedHeight);
        });
      });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final imageUrl = widget.item['image_url'].length > 0
        ? "$baseUrl/${widget.item['image_url'][0]}"
    ...
    return Scaffold(
      ...
      // MAIN BODY WITH COLLAPSING HEADER
              ...
              if (widget.item['image_url'].length > 0)
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Icon(Icons.zoom_out_map, size: 24)),
                  ),
                ),
            ],
          ...
          child: Column(
            ...
            children: [
              ...
              if (widget.item['details'] != null &&
                  widget.item['details'].toString().trim().isNotEmpty) ...[
                SizedBox(
                  height: getProportionateScreenHeight(kDefaultPadding / 2),
                ),
                Text(
                  widget.item['details'].toString().replaceAll("\n", "").trim(),
                  style: textTheme.bodyMedium?.copyWith(color: kGreyColor),
                ),
              ],
              ...
              // Specifications Header + Note Button
              Align(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(Icons.add, color: kBlackColor, size: 18),
                        SizedBox(width: 4),
                        Text(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            spacing: 10,
                            runSpacing: 10,
                            children: List.generate(sortedOptions.length, (
                              idx,
                            ) {
                              final opt = sortedOptions[idx];
                              final isSelected = selected.any(
                                (e) => e.uniqueId == opt['unique_id'],
                              );
                              ...
                              return ChoiceChip(
                                ...
                                selected: isSelected,
                                selectedColor: kSecondaryColor.withValues(
                                  alpha: 0.1,
                                ),
                                backgroundColor: kPrimaryColor,
                                ...
                                onSelected: (_) {
                                  final specItem = ListElement(
                                    uniqueId: opt['unique_id'],
                                    price: price,
                                  );

                                  final existingSpec = specification!
                                      .firstWhere(
                                        (e) => e.uniqueId == spec['unique_id'],
                                  ...
                                  if (existingSpec.uniqueId != -1) {
                                    final list = existingSpec.list!;
                                    if (list.any(
                                      (e) => e.uniqueId == specItem.uniqueId,
                                    )) {
                                      setState(() {
                                        list.removeWhere(
                                          (e) =>
                                              e.uniqueId == specItem.uniqueId,
                                        );
...
//                             final isRequired = spec['is_required'] == true;
//                             final specName =
//                                 widget.item['specifications'].length > 1
//                                 ? Service.capitalizeFirstLetters(
//                                     spec['name'].toString(),
//                                   )
//                                 : "Size";
